  ...
  (Plugin.prototype.init = function() {
    ...
    _$this.wrap("<div class='sp_wrapper'><div class='sp_table'>"),
      ...
      _$this
        ...
        .find(".sp_navigator")
        .append(
          '<span class="sp_paginate sp_previous"><a href="">上一頁<a/></span><span class="sp_paginate sp_next"><a href="">下一頁<a/></span></div>'
        );
    var paginate = function(start, size) {
      ...
      tableRows.hide(),
        ...
        $(_$this)
          ...
          .show(),
        tableRows.eq(0).is(":visible") &&
          $(_$this)
            .closest(".sp_wrapper")
            .find(".sp_navigator .sp_previous")
            .hide(),
        tableRows.eq(tableRows.length - 1).is(":visible") &&
          $(_$this)
            .closest(".sp_wrapper")
    ...
    _$this.find("th").on("click", function() {
      $(_$this)
        ...
        $(this).hasClass("sp_sorted_asc") || $(this).hasClass("sp_sorted_desc")
