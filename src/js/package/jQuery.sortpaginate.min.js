...
$(function ($, window, document, undefined) {
  ...
  Plugin.prototype.init = function () {
    ...
    _$this.wrap('<div class=\'sp_wrapper\'><div class=\'sp_table\'>'), _$this.parent().after('<div class="sp_navigator">'), _$this.closest('.sp_wrapper').find('.sp_navigator').append('<span class="sp_paginate sp_previous"><a href="">上一頁<a/></span><span class="sp_paginate sp_next"><a href="">下一頁<a/></span></div>')
